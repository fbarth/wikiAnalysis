...
public class BrazilianStemmer
{
     ...
     * Gets R1
     * 
     * R1 - is the region after the first non-vowel follwing a vowel, or is the
     ...
     * Gets RV
     * 
     * RV - IF the second letter is a consoant, RV is the region after the next
     * following vowel,
     * 
     * OR if the first two letters are vowels, RV is the region after the next
     * consoant,
     * 
     * AND otherwise (consoant-vowel case) RV is the region after the third
     * letter.
     * 
    ...
    /**
     * 1) Turn to lowercase 2) Remove accents 3) Ã£ -> a ; Ãµ -> o 4) Ã§ -> c
     * 
    ...
    private String changeTerm(String value)
    {
        ...
        for (j = 0; j < value.length(); j++) {
            if ((value.charAt(j) == 'ã') || (value.charAt(j) == 'á') || (value.charAt(j) == 'à') || (value.charAt(j) == 'â')) {
                r = r + "a";
                continue;
            }
            ...
            if ((value.charAt(j) == 'ú') || (value.charAt(j) == 'ù')) {
                r = r + "u";
                continue;
            }
            if (value.charAt(j) == 'ç') {
    ...
    /**
     * Creates CT (changed term) , substituting * 'Ã£' and 'Ãµ' for 'a~' and
     * 'o~'.
     */
    private void createCT(String term)
    {
        ...
        if ((CT.charAt(0) == '"') || (CT.charAt(0) == '\'') || (CT.charAt(0) == '-') || (CT.charAt(0) == ',') || (CT.charAt(0) == ';') || (CT.charAt(0) == '.') || (CT.charAt(0) == '?')
                        || (CT.charAt(0) == '!')) {
            CT = CT.substring(1);
        }
        ...
        if ((CT.charAt(CT.length() - 1) == '-') || (CT.charAt(CT.length() - 1) == ',') || (CT.charAt(CT.length() - 1) == ';') || (CT.charAt(CT.length() - 1) == '.')
                        || (CT.charAt(CT.length() - 1) == '?') || (CT.charAt(CT.length() - 1) == '!') || (CT.charAt(CT.length() - 1) == '\'') || (CT.charAt(CT.length() - 1) == '"')) {
            CT = CT.substring(0, CT.length() - 1);
        }
    }

    /**
     * Standart suffix removal. Search for the longest among the following
     * suffixes, and perform the following actions:
     * 
     ...
     * Residual suffix
     * 
     * If the word ends with one of the suffixes (os a i o Ã¡ Ã­ Ã³) in RV,
     * delete it
     * 
     */
    private void step4()
    ...
    /**
     * If the word ends with one of ( e Ã© Ãª) in RV,delete it, and if preceded
     * by 'gu' (or 'ci') with the 'u' (or 'i') in RV, delete the 'u' (or 'i')
     * 
