...
public class WVToolUPGMA extends JFrame{
	...
	private Component runExperiment(String diretorio){
		try{
	        ...
	        MyClusterGraphVisualization result;
	        if(documento==null)
	        	result = new MyClusterGraphVisualization(hcm);
	        else
	        	result = new MyClusterGraphVisualization(hcm,this.documento);
	...
	public WVToolUPGMA(String diretorio){
		try{
	...
	public WVToolUPGMA(String diretorio, String documento){
		try{
