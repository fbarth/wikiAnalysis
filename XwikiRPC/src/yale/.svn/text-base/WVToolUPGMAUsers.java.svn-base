...
/**
 * 
 * IMPORTANTE: O único algoritmo realmente utilizado
 * é o algoritmo UPGMA (agrupamento hierárquico). 
 * 
 * Não sei se é a melhor técnica para agrupar perfis de usuários !!!
 * 
 * Dado um conjunto de perfis de usuários, esta classe
 * aplica ao conjunto de perfis um algoritmo de agrupamento hierárquico (UPGMA)
...
public class WVToolUPGMAUsers extends JFrame{
	...
	private Component runExperiment(String diretorio){
		try{
	        ...
	        MyClusterGraphVisualizationUsers result = new MyClusterGraphVisualizationUsers(hcm);
	        return result;
	...
	public WVToolUPGMAUsers(String diretorio){
		try{
